...
dirname = "/home/medcvr/yifei/thesis/runs/dvrk_reach_mvd/3292047/trained_models/env_step375000/"
filename = "models.pt"
...
example_obs = (torch.randn(1, 3, 84, 84).to(device=reach_cfg.device), None, False, False, True, True)
